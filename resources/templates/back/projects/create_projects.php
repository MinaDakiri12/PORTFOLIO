            ...
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">
                        By submitting this form you will create a new projects
                    </div>
                </div>
            </div>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="" >
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Enter your title projects" name="title"  required=""  />
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Enter your github projects "name="github" required="" />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Enter your link's projects" name="link" required="" />
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
